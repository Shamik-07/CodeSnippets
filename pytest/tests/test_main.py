...
@pytest.mark.parametrize(
    "test_input, expected_output", [(1, 2), (0, 1), (-1, 0), (9, 10)]
)
    ...
    [
        ...
        pytest.param(
            ...
            marks=pytest.mark.skipif(
                sys.version_info >= (3, 0), reason="***needs to run on python2***"
            ),
        ),
    ],
)
...
@pytest.mark.skipif(sys.version_info >= (3, 0), reason="***needs to run on python2***")
def test_skipif():
    assert 1 == 1
